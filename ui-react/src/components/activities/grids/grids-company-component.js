...
const UPDATE_DATA = gql`
    mutation updateData($nodeLabel: String, $nodeId: String, $companyId: String, $label: String) {
        updateData(nodeLabel: $nodeLabel, nodeId: $nodeId, unitId: $companyId, label: $label)
    }
`;
...
export default function GridCompanyComponent({companies, refetch, companyId}){
