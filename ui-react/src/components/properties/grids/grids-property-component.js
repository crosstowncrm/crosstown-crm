...
import { Grid, Divider, CardContent, Typography, CardActionArea, Avatar } from "@material-ui/core";
...
const headCells = [
    "Note", "Email", "Call", "Log",  "Task", "Meet"
];

const UPDATE_DATA = gql`
    mutation updateData($nodeLabel: String, $nodeId: String, $propertyId: String, $label: String) {
        updateData(nodeLabel: $nodeLabel, nodeId: $nodeId, unitId: $propertyId, label: $label)
    }
`;
...
export default function GridPropertyComponent({properties, refetch, propertyId}){
