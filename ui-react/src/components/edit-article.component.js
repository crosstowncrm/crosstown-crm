            ...
            {data.Article.map(article => {
              return (
                <TableRow key={article.id}>
                  ...
                  <TableCell>{article.title ? article.title: "no data"}</TableCell>
                  <TableCell>{article.excerpt ? article.excerpt: "no data"}</TableCell>
                  <TableCell>{article.content ? article.content: "no data"}</TableCell>
                  <TableCell>{article.source ? article.source: "no data"}</TableCell>
                  <TableCell>{article.link ? article.link: "no data"}</TableCell>
                  <TableCell>
                    ...
                    <TableCell>
                        {article.opened_source.map(opened => (
                            <Link key={opened.Contact.id} className="edit-link" to={"/contacts/" + opened.Contact.id}>
